...
import TankuangTwo from '../norepeat/tankuang_two';
...
let str1= {
 ...
 class Container extends Component {
    ...
    render() {
        let children;
        if(this.props.location.pathname=="/student/repos"||this.props.location.pathname=="/student"){
                ...
                <div className="box">

                    {
                       ...
                       <LeftSelect students={this.state.data.students
                                   ...
                                   changeIndex={this.changeIndex} pathName={ this.props.location.pathname}/>
